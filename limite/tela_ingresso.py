...
class TelaIngresso:
	...
	def pega_poltrona(self):
		...
		coluna10 = [
			[sg.Button('H-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
			[sg.Button('G-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
			[sg.Button('F-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
			[sg.Button('E-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
			[sg.Button('D-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
			[sg.Button('C-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
			[sg.Button('B-10', image_filename=poltrona_image, image_size=(30, 30), font='impact', button_color='white')],
